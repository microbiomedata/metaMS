...
The versioning of the repo, docker image and the GC/MS workflow are currently 3.3.0.
The version of the lipid workflow is currently 1.3.0.
The version of the LCMS metabolomics workflow is currently 1.1.0.
